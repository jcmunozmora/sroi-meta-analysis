...
This section documents the three statistical methods used to quantify uncertainty and estimate the implications of non-compliance. All simulations use the full 383-report corpus or the 247-report LLM-extracted ratio subsample (excluding 4 outliers >50:1). Full code is available in the [Replication](replication.qmd) section.
...
![Monte Carlo simulation results: distribution of the ratio correction factor and implied adjusted SROI ratios, based on the 247 LLM-extracted reports with extractable ratios (outliers >50:1 excluded).](figures/fig10_mc_ratio_bias.png)
...
![Caterpillar plot showing the 247 extractable SROI ratios with their Monte Carlo–corrected distributions (5th–95th percentile intervals). Reports with higher observed ratios show wider correction intervals.](figures/fig11_mc_caterpillar.png)
