...
::: {.grid-2}
| | Assured (n=63) | Not assured (n=320) | Gap |
|--|--------------|---------------------|-----|
| P1 | 1.38 | 1.09 | +0.29 |
| P2 | 1.50 | 1.27 | +0.23 |
| P3 | 1.13 | 0.71 | +0.42 |
...
```
Quality_score_i = β₀ + Σ sector_dummies + Σ country_dummies + Σ org_type_dummies
                      + Assured_i + Year_std_i + Log(stakeholders)_i + ε_i

N = 265   R² = 0.417   Adj. R² = 0.381   (HC3 robust standard errors)
```

| Predictor | Coefficient (pp) | Std. Error | p-value |
|-----------|-----------------|------------|---------|
| Log(stakeholder groups) | +8.40 | 0.99 | <0.001 |
| Formal assurance | +10.36 | 2.78 | <0.001 |
| Australia (vs UK) | −7.98 | 3.31 | 0.016 |
| Constant | 26.9 | 1.83 | <0.001 |

::: {.callout-note}
**Interpretation.** Stakeholder engagement and formal assurance are the two dominant predictors after controlling for sector, country, org type, and year. The Australia dummy reflects the SROI practicum context (Vienna/University of the Sunshine Coast reports). No sector dummy reaches significance, consistent with the permutation test result.
:::
